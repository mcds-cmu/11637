...
nav_order: 10
description: >-
    Contact Information for Foundations of Computational Data Science.
---
...
{% assign instructors = site.staffers | where: 'role', 'Instructor' | where: 'staff_for', 's26' | sort:"list_order" %}
